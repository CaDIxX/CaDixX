...
quem_fez_gol = [0.4, 0.25,0.25,0.2,0.1,0.05,0.05,0.05,0.02,0.02,0.001] # chances de cada posição fazer um gol
...
print(f'Placar final: {placar1}x{placar2}') # Mostra placar final
